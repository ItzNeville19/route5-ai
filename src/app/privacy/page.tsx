  ...
  return (
    <main className="route5-brand-dark-marketing-shell min-h-dvh w-full bg-[#09090f] text-zinc-100 antialiased">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 lg:max-w-4xl lg:py-24">
        <div className="mb-12">
          <h1 className="mb-4 text-4xl font-bold tracking-[-0.03em] text-white">Privacy Policy</h1>
        ...
        <div className="max-w-none space-y-10">
          {sections.map((section) => (
            ...
            >
              ...
              <div className="space-y-3 whitespace-pre-line leading-relaxed text-zinc-200">
