...
export default function OverviewPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[min(100%,1280px)] space-y-2.5 pb-8">
      <section className="route5-card relative overflow-hidden rounded-2xl border border-r5-border-subtle bg-r5-surface-primary px-4 py-3 shadow-[0_12px_30px_-24px_rgba(14,165,233,0.35)]">
        <div
          className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_60%_at_8%_-20%,rgba(56,189,248,0.2),transparent_62%),radial-gradient(ellipse_75%_55%_at_96%_-10%,rgba(99,102,241,0.16),transparent_60%)]"
          aria-hidden
        />
        <div className="relative grid gap-2 md:grid-cols-[minmax(0,1fr)_320px] md:items-end">
          <div>
            <p className="text-[11px] font-semibold tracking-[0.08em] text-r5-text-secondary">Home</p>
            <h1 className="mt-1 text-[20px] font-semibold tracking-[-0.01em] text-r5-text-primary">
              Execution overview
            </h1>
            <p className="mt-1 max-w-[62ch] text-[12px] leading-relaxed text-r5-text-secondary">
          ...
          <div className="route5-card rounded-xl border border-r5-border-subtle/90 bg-r5-surface-secondary/75 px-3 py-2 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
            <p className="text-[10px] font-semibold tracking-[0.08em] text-r5-text-secondary">Operational pulse</p>
            <p className="mt-1 text-[13px] text-r5-text-primary">
              {metrics.overdue > 0 || metrics.blocked > 0 || metrics.unaccepted > 0
                ? `${metrics.overdue + metrics.blocked + metrics.unaccepted} commitments need immediate leadership attention.`
                : "No urgent escalations right now. Execution quality is stable."}
            </p>
          </div>
        </div>
        <div className="relative mt-2.5 flex flex-wrap gap-2">
          <Link
            href="/desk"
            className="route5-pressable inline-flex rounded-full bg-r5-accent px-4 py-2 text-[12px] font-semibold text-white shadow-[0_4px_14px_-12px_rgba(59,130,246,0.65)]"
          >
            Open Desk
          </Link>
          <Link
            href="/workspace/customize"
            className="route5-pressable inline-flex rounded-full border border-r5-border-subtle bg-r5-surface-secondary px-3.5 py-2 text-[12px] font-medium text-r5-text-primary hover:bg-r5-surface-hover"
          >
            Customize
          </Link>
        </div>
      ...
      <section className="route5-card rounded-2xl border border-r5-border-subtle bg-r5-surface-primary p-2.5 shadow-[0_8px_22px_-20px_rgba(14,165,233,0.3)]">
...
function MetricCard({ label, value, hint }: { label: string; value: number; hint: string }) {
  return (
    <div className="route5-card rounded-xl border border-r5-border-subtle bg-r5-surface-primary p-2.5 shadow-[0_10px_24px_-22px_rgba(14,165,233,0.4)]">
      <div className="mb-1 h-px w-full bg-gradient-to-r from-sky-400/45 via-indigo-400/35 to-transparent" aria-hidden />
      <p className="text-[10px] font-semibold tracking-[0.08em] text-r5-text-secondary">{label}</p>
