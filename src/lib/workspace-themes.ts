...
export const WORKSPACE_THEME_LABELS: Record<Exclude<WorkspaceThemeId, "auto">, string> = {
  ...
  vegas: "Las Vegas — real Strip night photo (neon) with contrast scrim",
  nyc: "New York City — real Manhattan skyline with harbor tones",
...
export const WORKSPACE_THEME_DESCRIPTIONS: Record<Exclude<WorkspaceThemeId, "auto">, string> = {
  ...
  vegas: "Photograph of the Las Vegas Strip at night; dark scrim keeps purple UI text crisp.",
  nyc: "Photograph of the Manhattan skyline; blue-hour scrim matches the midnight-cobalt UI.",
