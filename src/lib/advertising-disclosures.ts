...
export const ADVERTISING_DISCLOSURES = {
   ...
   */
  plansGrid:
    "Limits and features describe the in-app product in its current release. Workspace data is per signed-in account unless your contract says otherwise. Integrations require API credentials or manual flows as each integration page explains. Multi-seat org controls and some connectors may be on the roadmap—see the product page and guides. Set NEXT_PUBLIC_BILLING_LIVE=1 when you are commercially open; Subscribe-style CTAs may route through Contact until card checkout is integrated. Marketing pages are not a binding offer; your order, MSA, or Terms control.",
