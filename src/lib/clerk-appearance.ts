/**
 * Dark, high-contrast auth UI for Route5 — avoids light Clerk defaults on dark pages
 * (invisible titles, white input slabs on black, etc.).
 */
export const route5ClerkAppearance = {
  ...
  elements: {
    rootBox: "w-full",
    cardBox: "border border-white/[0.12] bg-[#050505] shadow-2xl shadow-black/60",
    card: "border border-white/[0.12] bg-[#050505] shadow-2xl shadow-black/60",
